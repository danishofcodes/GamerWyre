export default function Searchbar({handleInput,searchquery}) {
  return (
    // <div>
...
<form className="flex items-center max-w-sm mb-5">   
    ...
    <div className="relative w-full">
        ...
        <input type="text" id="simple-search" onChange={handleInput} value={searchquery} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-stone-500 focus:border-stone-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-stone-500 dark:focus:border-blue-500 rounded-full" placeholder="Search ..."  />
